...
# [Barrier #1]{style="color: #DAA520"}: File naming and management  
...
# [Solution #1]{style="color: #DAA520"}: principled file naming and project management  
...
# [Barrier #2]{style="color: #0080FF"}: Proprietary, point-and-click software  
...
# [Solution #2]{style="color: #0080FF"}: free programing languages  
...
# [Barrier #3]{style="color: #0080FF"}: Static programming and environment  
...
# [Solution #3]{style="color: #0080FF"}: Literate programming (and IDEs)  
...
# [Barrier #4]{style="color: #66CC00"}: Keeping track of changes  
...
# [Solution #4]{style="color: #66CC00"}: Version control  
...
# [Barrier #5]{style="color: #FFB266"}: Reproducibility requires sharing  
...
# [Solution #5]{style="color: #FFB266"}: Open data and code  
...
# [Barrier #6]{style="color: #FFB266"}: What if software versions change?  
...
# [Solution #6]{style="color: #FFB266"}: Containerization  
...
## Reproducible science is about...  {background-image="path.png" background-opacity="0.2"}
...
- Using **containers**    
- Others (custom functions, iteration, etc.)  
...
- Interested in all these topics and wish to learn and apply them to your own research?  

- [**CRSS XXXX: Applications of data science in agricultural research**, Spring 2024]{style="color:#BA0C2F"}
